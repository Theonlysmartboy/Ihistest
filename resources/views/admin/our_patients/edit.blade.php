...
@section('content')
    ...
    {!! Form::model($our_patient, ['method' => 'PUT', 'route' => ['admin.our_patients.update', $our_patient->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($our_patient->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$our_patient->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$our_patient->photo) }}"></a>
                    @endif
